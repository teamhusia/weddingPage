export const kr = {
  translations: {
    ...
    INVITATION_NAMES: "",
    INVITATION_NAMES_2: "",
    INVITATION_TEXT: `평생을 같이하고 싶은 사람을 드디어 만났습니다.\n
      서로 아껴주고 이해하며\n
      사랑 베풀며 살고 싶습니다.\n
    ...
    INVITATION_TIME: "",
    INVITATION_PLACE:
      "결혼식 예배 시간 및 장소 : 2023 년 8 월 13 일 오후 3 시 (유럽 서머타임), 폴란드 포즈난 파라 대성당",
    INVITATION_PLACE_2:
    ...
    COUNTDOWN_TITLE: "The big day is comming!",
  }
};

export const KR_SIGNATURE = {
  GROOM: ["최동준", "·", "이정자", "의", "아들", "흥재"],
  BRIDE: ["Gerard Koprowski", "·", "Jolanta Koprowska", "의", "딸", "Katarzyna"]
};
